...
export class MiniJamRuntime implements JamOsRuntimeV2 {
  ...
  readonly doom: DoomRuntime = new MiniJamDoomRuntime({ api: this.api, work: this.work, serviceId: import.meta.env.VITE_DOOM_SERVICE_ID, gatewayUrl: import.meta.env.VITE_DOOM_GATEWAY_URL });
