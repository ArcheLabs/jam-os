...
export class JamNameService {
  ...
  private serviceId() { const configured = import.meta.env.VITE_JNS_SERVICE_ID; if (configured) return configured; if (import.meta.env.VITE_JAM_MODE === "live") throw new JnsNotConfiguredError(); return "jns-mock"; }
