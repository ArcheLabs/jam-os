...
const checks = [
  ...
  [ci.includes("scripts/bootstrap-llvm.sh") && llvmLock.includes('clang_version = "Ubuntu clang version 20.1.8'), "main CI must install the exact locked LLVM toolchain"],
