...
console.log(JSON.stringify({ network: config.name || config.networkName || "MiniJAM", jnsService: jnsView.serviceId, computerService: computerView.serviceId, doomService: doomView?.serviceId || null, controller: computerView.controller, mutation: "not attempted" }, null, 2));
